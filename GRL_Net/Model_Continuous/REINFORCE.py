...
class Graph_Model(nn.Module):
    ...
    def __init__(self, N, F, A, action_min, action_max):
        ...
        # Normal distribution
        self.policy_mu = nn.Linear(32, A)
        self.policy_sigma = nn.Linear(32, A)
    ...
    def forward(self, observation):
        ...
        # Action generation
        Policy_mu = self.policy_mu(X_policy)
        Policy_sigma = self.policy_sigma(X_policy)

        return Policy_mu, Policy_sigma

...
def make_create_env(params, version=0, render=None):
    ...
    def create_env(*_):
        ...
        """
            This part instantiates the network class twice and 
            may generate errors for networks that have already been instantiated
        """
        ...
        """
            If the network has already been instantiated in main.py, 
            comment out the above statement and run the following
        """
        # network = network_class
